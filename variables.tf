...
variable "aws_wafregional_byte_match_set_allowed_hosts_name" {
  description = "The name of the aws_wafregional_byte_match_set used by the rule used for filtering by host header.  Defaults to \"[name]-allowed-hosts\"."
  type        = string
  default     = ""
}

variable "aws_wafregional_rule_allowed_hosts_name" {
  description = "The name of the rule used for filtering by host header.  Defaults to \"[name]-allowed-hosts\"."
  type        = string
  default     = ""
}

variable "aws_wafregional_rule_allowed_hosts_metric_name" {
